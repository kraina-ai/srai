...
0. Make sure you have installed at least version **3.10+** of Python.
...
2. Install package locally (will download all dev packages and create a local venv)
    ...
    pdm venv create 3.10 # or any higher version of Python
...
```sh
tox -e python3.12 # put your python version here
```
...
All Python code must be written **compatible with Python 3.10+**.
